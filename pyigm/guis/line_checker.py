...
class InspectionWidget(QWidget):
    """ Widget for a velocity plot with interaction.
        ...
        14-Aug-2015 by JXP
    """
    def __init__(self, ispec, wv_lya, parent=None, llist=None, norm=True, screen_scale=1.,
    vmnx=[-500., 500.]*u.km/u.s, fwhm=0., plot_residuals=True, external_model=None):
        ...
        '''
        super(InspectionWidget, self).__init__(parent)
