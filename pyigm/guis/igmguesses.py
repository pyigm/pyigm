...
def from_igmguesses_to_veeper(infile, outfile):
    """Reads .json file generated by IGMGuesses and translates it to
    input file(s) for Veeper (.joebvp).
    ...
    ltiio.joebvp_from_components(complist, igmg_dict['spec_file'], outfile)
