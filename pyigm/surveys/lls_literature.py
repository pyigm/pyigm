...
from pyigm.abssys import lls import as pylls
...
def zonak2004():
    ...
    lls.subsys['A']._ionN =  pylls.dict_to_ions(adict)
    ...
    lls.subsys['B']._ionN =  pylls.dict_to_ions(bdict)
    # Total
    lls._ionN = lls.subsys['A']._ionclms.sum(lls.subsys['B']._ionclms)
