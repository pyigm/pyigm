...
sys.path.insert(0, os.path.abspath('../pyigm'))
...
latex_documents = [
  (master_doc, 'pyigm.tex', u'pyigm Documentation',
...
man_pages = [
    (master_doc, 'pyigm', u'pyigm Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'pyigm', u'pyigm Documentation',
   author, 'pyigm', 'One line description of project.',
   'Miscellaneous'),
]
